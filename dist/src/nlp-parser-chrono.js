...
export function parseMessage(message) {
    ...
    if (city)
        result.startingCity = city;
    const theme = parseTripTheme(message);
    if (theme)
        result.tripTheme = theme;
 ...
 */
function parseChronoDateRange(message) {
    try {
 ...
 */
function parseTripTheme(message) {
    const messageLower = message.toLowerCase();
 ...
 */
function parseGroupType(message) {
    const messageLower = message.toLowerCase();
 ...
 */
function parseTransportMode(message) {
    const messageLower = message.toLowerCase();
 ...
 */
function parseStayPreference(message) {
    const messageLower = message.toLowerCase();
 ...
 */
function parseAdventureLevel(message) {
    const messageLower = message.toLowerCase();
 ...
 */
function parseFoodPreference(message) {
    const messageLower = message.toLowerCase();
 ...
 * Parse comfort level
 */
function parseComfortLevel(message) {
    const messageLower = message.toLowerCase();
 ...
 */
function parseSchedulePreference(message) {
    const messageLower = message.toLowerCase();
 ...
 */
function parseWeatherPreference(message) {
    const messageLower = message.toLowerCase();
 ...
 */
function parseSpecialNeeds(message) {
    const specialNeeds = [];
 ...
 */
function parsePlacesList(message) {
    const visit = [];
    const avoid = [];
